...
create_category==INSERT INTO categories (name, parent_id, description) VALUES (?, ?, ?)
...
update_mapping==INSERT INTO `categories_mapping` (`product_name`, `category_id`) VALUES (?, ?)
...
contains_product_in_mapping==SELECT * FROM `categories_mapping` WHERE `product_name` LIKE ?
